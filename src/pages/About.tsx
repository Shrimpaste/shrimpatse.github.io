    ...
    <div className="min-h-screen pt-24 pb-16 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <motion.div
          ...
          className="mb-12"
        >
          <TerminalPrompt className="mb-4">cat about.md</TerminalPrompt>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          >
            <div className="sticky top-24">
              {/* Avatar Placeholder */}
              <div className="w-32 h-32 rounded-2xl bg-gradient-to-br from-amber-400/20 to-mint-400/20 border border-ink-600 flex items-center justify-center mb-6">
                <span className="text-4xl font-serif text-amber-400">
                  {author.name.charAt(0)}
                </span>
              </div>

              <h2 className="text-xl font-serif text-text-primary mb-1">
                {author.name}
              </h2>
              ...
              <div className="space-y-2 text-sm">
                ...
                <a
                  ...
                  className="flex items-center gap-2 text-text-secondary hover:text-amber-400 transition-colors"
                >
          ...
          >
            ...
            <section>
              ...
              <div className="grid grid-cols-2 gap-4">
                {skills.map((skill) => (
                  <div
                    key={skill.category}
                    className="p-4 rounded-xl bg-ink-800/50 border border-ink-600/50"
                  >
            ...
            <section className="pt-6 border-t border-ink-700/50">
              <TerminalPrompt className="mb-4">echo "保持联系"</TerminalPrompt>
              <p className="text-text-secondary mb-4">
                如果你对我的文章感兴趣，或者有合作的想法，欢迎通过邮件联系我。
              </p>
              <a
                href={`mailto:${author.email}`}
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-amber-400/10 border border-amber-400/50 rounded-lg text-amber-400 font-mono text-sm hover:bg-amber-400/20 transition-all"
              >
                <Mail size={16} />
                发送邮件
              </a>
